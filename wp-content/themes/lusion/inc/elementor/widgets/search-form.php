...
class Apr_Core_Search_Form extends Elementor\Widget_Base {
	...
	public function apr_sc_searchform() {
		/* Add css */
		if ( is_rtl() ) {
			wp_enqueue_style( 'apr-sc-searchform', LUSION_CSS . '/elementor/search-form-rtl.min.css', array(), LUSION_THEME_VERSION );
		} else {
			wp_enqueue_style( 'apr-sc-searchform', LUSION_CSS . '/elementor/search-form.min.css', array(), LUSION_THEME_VERSION );
		}
	}
	...
	protected function render() {
		...
		?>
		<form class="apr-searchform elementor-search-form" role="search" action="<?php echo home_url(); ?>"
			  method="get">
...
\Elementor\Plugin::instance()->widgets_manager->register( new Apr_Core_Search_Form );
