...
class wcva_global_values_per_attribute {
    ...
    public function wcva_register_scripts() {
	   ...
	   $translation_array = array( 
		      'uploadimage'    => esc_html__( 'Choose an image' ,'wcva'),
			  'useimage'       => esc_html__( 'Use Image' ,'wcva'),
	...
	public function add_category_fields() {
	 ...
	 wp_enqueue_style( 'wp-color-picker' );
		...
		<div class="" >
		    ...
		    <label><?php echo esc_html__( 'Display Type', 'wcva' ); ?></label>
			<select id="display_type" name="display_type">
				<option value="textblock"><?php echo esc_html__('Text Block','wcva'); ?></option>
			    <option value="Color"><?php echo esc_html__('Color','wcva'); ?></option>
			    <option value="Image"><?php echo esc_html__('Image','wcva'); ?></option>
			</select>
			
			<br /><br />
            <div id="wcvacolorp" style="display:none;">
		        <label for="_chose_color"><span class="wcvaformfield"><?php echo esc_html__('Chose Color','wcva'); ?></span></label> 
			...
			<label><?php echo esc_html__( 'Thumbnail', 'wcva' ); ?></label>
			...
			<div class="image-upload-div" style="line-height:60px;" idval="1">
				...
				<button type="button" class="wcva_upload_image_button_1 button"><?php echo esc_html__( 'Upload/Add image', 'wcva' ); ?></button>
				<button type="button" class="wcva_remove_image_button_1 button"><?php echo esc_html__( 'Remove image', 'wcva' ); ?></button>
			</div>
			</div>
			
			<br />
			<div id="wcvahoverdiv" style="">
			<label><?php echo esc_html__( 'Hover Image', 'wcva' ); ?></label>
			...
			<div class="image-upload-div" style="line-height:60px;" idval="2">
				...
				<button type="button" class="wcva_upload_image_button_2 button"><?php echo esc_html__( 'Upload/Add image', 'wcva' ); ?></button>
				<button type="button" class="wcva_remove_image_button_2 button"><?php echo esc_html__( 'Remove image', 'wcva' ); ?></button>
			</div>
			</div>
			
			<br />
			<div id="wcvatextblockp" style="display:block;">
		      <label for="_textblock_text"><span class="wcvaformfield"><?php echo esc_html__('Text','wcva'); ?></span></label> 
		...
		?>
		<tr class="form-field">
		   <th scope="row" valign="top"><label><?php echo esc_html__( 'Display Type', 'wcva' ); ?></label></label></th>
		   <td>
			    <select id="display_type" name="display_type" >
			    	<option value="textblock" <?php if (isset($display_type) && ($display_type == "textblock")) { echo 'selected'; }  ?>><?php echo esc_html__('Text Block','wcva'); ?></option>
			        <option value="Color" <?php if (isset($display_type) && ($display_type == "Color")) { echo 'selected'; }  ?>><?php echo esc_html__('Color','wcva'); ?></option>
			        <option value="Image" <?php if (isset($display_type) && ($display_type == "Image")) { echo 'selected'; }  ?>><?php echo esc_html__('Image','wcva'); ?></option>
		...
		<tr class="form-field" id="wcvatextblockp" style="<?php if (isset($display_type) && (($display_type == "Image") ||  ($display_type == "Color"))) { echo 'display:none;'; } else { echo 'display:;'; }  ?>">
		   <th scope="row" valign="top"><label><?php echo esc_html__('Text','wcva'); ?></label></label></th>
		   <td>
		...
		<tr class="" id="wcvacolorp" style="<?php if (isset($display_type) && ($display_type == "Color")) { echo 'display:;'; } else { echo 'display:none;'; }  ?>">
		   <th scope="row" valign="top"><label><?php echo esc_html__('Chose Color','wcva'); ?></label></label></th>
		   <td>
			 <input name="color" type="text" class="wcvaattributecolorselect" value="<?php if (isset($color)) { echo $color;} else { echo '#ffffff';}  ?>" data-default-color="#ffffff">
		   </td>
		</tr>
		...
		<tr class="form-field" id="wcvaimagep" style="<?php if (isset($display_type) && ($display_type == "Image")) { echo 'display:;'; } else { echo 'display:none;'; }  ?>">
			<th scope="row" valign="top"><label><?php echo esc_html__( 'Thumbnail', 'wcva' ); ?></label></th>
			<td>
				...
				<div class="image-upload-div" style="line-height:60px;" idval="1">
					...
					<button type="submit" class="wcva_upload_image_button_1 button"><?php echo esc_html__( 'Upload/Add image', 'wcva' ); ?></button>
					<button type="submit" class="wcva_remove_image_button_1 button"><?php echo esc_html__( 'Remove image', 'wcva' ); ?></button>
				</div>
		...
		<tr class="form-field" id="wcvahoverdiv" style="">
			<th scope="row" valign="top"><label><?php echo esc_html__( 'Hover Image', 'wcva' ); ?></label></th>
			<td>
				...
				<div class="image-upload-div" style="line-height:60px;" idval="2">
					...
					<button type="submit" class="wcva_upload_image_button_2 button"><?php echo esc_html__( 'Upload/Add image', 'wcva' ); ?></button>
					<button type="submit" class="wcva_remove_image_button_2 button"><?php echo esc_html__( 'Remove image', 'wcva' ); ?></button>
				</div>
				<script type="text/javascript">
	...
	public function term_columns( $columns ) {
		...
		$new_columns['thumb'] = esc_html__( 'Preview', 'wcva' );
		$new_columns['hoverimage'] = esc_html__( 'Hover Image', 'wcva' );
