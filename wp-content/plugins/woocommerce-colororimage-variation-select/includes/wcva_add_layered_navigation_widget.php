...
class wcva_swatches_widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			esc_html__('WooSwatches Filter', 'wcva'), // Name
			array('description' => esc_html__( 'WooSwatches color/image swatches filter widget', 'wcva' ),) // Args
		);
	}
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'wcva_widget_title' ); ?>"><?php echo esc_html__( 'Title','wcva' ); ?></label>
			<input class="widefat " id="<?php echo $this->get_field_id( 'wcva_widget_title' ); ?>" name="<?php echo $this->get_field_name( 'wcva_widget_title' ); ?>" type="text" value="<?php if (isset($instance['wcva_widget_title'])) { echo $instance['wcva_widget_title']; } else { echo esc_html__( 'Filter by','wcva' ); } ?> ">
		</p>
		
		<p>
		    <label for="<?php echo $this->get_field_id( 'filter_attribute' ); ?>"><?php echo esc_html__( 'Attribute','wcva' ); ?></label>
		...
		<p>
		    <label for="<?php echo $this->get_field_id( 'query_type' ); ?>"><?php echo esc_html__( 'Query type','wcva' ); ?></label>
			<select class="widefat" id="<?php echo $this->get_field_id( 'query_type' ); ?>" name="<?php echo $this->get_field_name( 'query_type' ); ?>">
		      <option value="and" <?php if (isset($instance[ 'query_type' ]) && $instance[ 'query_type' ] == "and") { echo 'selected'; } ?>><?php echo esc_html__('AND','wcva'); ?></option>
			  <option value="or" <?php if (isset($instance[ 'query_type' ]) && $instance[ 'query_type' ] == "or") { echo 'selected'; } ?>><?php echo esc_html__('OR','wcva'); ?></option>
			</select>
		</p>
