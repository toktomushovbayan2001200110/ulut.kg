...
/**
 * Class Arrowpress_Free_Theme
 *
 * @since 1.3.0
 */
class Arrowpress_Free_Theme extends Arrowpress_Singleton {
    ...
    public static function is_free() {
        return ! ! get_theme_support( 'arrowpress-core-lite' );
    }
    ...
    public static function get_theme_id() {
        return apply_filters( 'arrowpress_core_my_theme_id', false );
    }
    ...
    public static function get_update_themes() {
        $update = get_option( 'arrowpress_core_check_update_my_themes', array() );
    ...
    /**
     * Arrowpress_Free_Theme constructor.
     *
     * @since 1.3.0
     */
    ...
    private function hooks() {
        add_action( 'arrowpress_core_background_check_update_theme_lite', array( $this, 'background_check_update_theme' ) );
        add_filter( 'arrowpress_core_get_link_download_theme', array( $this, 'get_link_download_theme' ), 10, 2 );
        add_filter( 'arrowpress_core_can_update_theme', array( $this, 'can_update_theme' ) );
    }
    ...
    public function get_link_download_theme( $return, $slug ) {
        ...
        $update_themes = Arrowpress_Free_Theme::get_update_themes();
        $themes        = $update_themes['themes'];
    ...
    public function check_theme_update( $force ) {
        ...
        $checker    = new Arrowpress_Check_Update_My_Theme( $slug, $current_version, $id );
        ...
        update_option( 'arrowpress_core_check_update_my_themes', $update_themes );
    }
}