...
var Arrowpress_Plugins = (function ($) {
    var ajax_url = arrowpress_plugins_manager.admin_ajax_action;
    ...
    function request(action, slug) {
        ...
        return $
            .ajax({
                ...
                method: 'POST',
                data: {
                    action: 'arrowpress_plugins_manager',
...
var Arrowpress_Plugins_Queue = (function ($) {
    var actions = [];
    ...
    function _run() {
        ...
        Arrowpress_Plugins.request(first.action, first.slug)
