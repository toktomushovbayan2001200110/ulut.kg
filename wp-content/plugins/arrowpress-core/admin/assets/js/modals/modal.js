...
(function ($) {
    var Arrowpress_Modal_Iframe = Backbone.View.extend({
        el: '#tc-modal-iframe',
    ...
    var Arrowpress_Modal = Backbone.View.extend({
        el: '.tc-modal',
        ...
        onClickOpen: function (e) {
            ...
            $(window).trigger('arrowpress_modal_open', refModal);
        },
    ...
    $(document).ready(function () {
        new Arrowpress_Modal();
        new Arrowpress_Modal_Iframe();
    });
})(jQuery);