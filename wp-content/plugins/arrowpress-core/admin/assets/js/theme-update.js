(function ($) {
    ...
    $(document).ready(function () {
        var url_ajax = arrowpress_theme_update.admin_ajax;
        var action = arrowpress_theme_update.action;
        var i18l = arrowpress_theme_update.i18l;
        ...
        $(document).on('click', '.tc-button-deregister', function (e) {
            ...
            window.location.href = arrowpress_theme_update.url_deregister;
        });
        ...
        function request_update_theme() {
            var nonce = arrowpress_theme_update.nonce;
