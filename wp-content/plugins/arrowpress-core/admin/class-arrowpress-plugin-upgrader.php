...
/**
 * Class Arrowpress_Plugin_Upgrader
 *
 * @since 1.1.0
 */
class Arrowpress_Plugin_Upgrader {
	 ...
	 * @var string
	 */
	private static $tag = 'ARROWPRESS_CORE_CHECK_PLUGIN_UPDATE';
	 ...
	 * @var string
	 */
	private static $key_cached_information_plugins = 'arrowpress_core_information_plugins';
	...
	/**
	 * Arrowpress_Plugin_Upgrader constructor.
	 *
	 * @since 1.1.0
	 *
	 * @param $url_api
	 ...
	 * @since 1.1.0
	 *
	 * @param $plugin Arrowpress_Plugin
	 *
	 * @return bool|array
	 */
	...
	private function get_data_plugins() {
 		...
 		// add option arrowpress_fix_check_update_plugin in another theme
	...
	private function get_data_plugins_remote() {
		if ( ! $this->url_api ) {
			return new WP_Error( self::$tag, __( 'url_api is invalid', 'arrowpress-core' ) );
		}
		...
		$response = Arrowpress_Remote_Helper::post(
			$this->url_api,
			array(
				'body' => array(
					'plugins' => $arr_slugs,
