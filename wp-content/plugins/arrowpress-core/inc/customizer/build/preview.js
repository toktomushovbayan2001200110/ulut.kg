...
/* harmony export */   "default": () => (/* binding */ BackgroundPostMessage)
/* harmony export */ });
/* harmony import */ var _wordpress_hooks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/hooks */ "@wordpress/hooks");
/* harmony import */ var _wordpress_hooks__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_hooks__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _postmessage_postMessage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../postmessage/postMessage */ "./src/postmessage/postMessage.ts");
// domready.


function BackgroundPostMessage() {
  return (0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_0__.addFilter)('thimCustomizerPostMessageStylesOutput', 'thim', function (styles, value, output, controlType) {
    var processedValue;
    if ('arrowpress-background' === controlType) {
      ...
      _.each(value, function (val, key) {
        ...
        processedValue = _postmessage_postMessage__WEBPACK_IMPORTED_MODULE_1__["default"].util.processValue(output, val);
        if ('' === processedValue) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ ThimPostMessageOutput)
/* harmony export */ });
/* harmony import */ var _postMessage__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./postMessage */ "./src/postmessage/postMessage.ts");
    ...
    wp.customize(fieldSetting, function (value) {
      value.bind(function (newVal) {
        ...
        _.each(field.js_vars, function (output) {
          output.function = !output.function || 'undefined' === typeof _postMessage__WEBPACK_IMPORTED_MODULE_0__["default"][output.function] ? 'css' : output.function;
          field.type = field.choices && field.choices.parent_type ? field.choices.parent_type : field.type;
          if ('css' === output.function) {
            styles += _postMessage__WEBPACK_IMPORTED_MODULE_0__["default"].css.fromOutput(output, newVal, field.type);
          } else {
            _postMessage__WEBPACK_IMPORTED_MODULE_0__["default"][output.function].fromOutput(output, newVal, field.type);
          }
        });
        _postMessage__WEBPACK_IMPORTED_MODULE_0__["default"].styleTag.addData(fieldSetting, styles);
      });
    });
  });
}
...
/***/ "./src/postmessage/postMessage.ts":
/*!****************************************!*\
  !*** ./src/postmessage/postMessage.ts ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (thimPostMessage);
...
/* harmony import */ var _background_postmessage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./background/postmessage */ "./src/background/postmessage.ts");


document.addEventListener('DOMContentLoaded', function () {
  (0,_postmessage__WEBPACK_IMPORTED_MODULE_0__["default"])();
  (0,_background_postmessage__WEBPACK_IMPORTED_MODULE_1__["default"])();
});
})();
