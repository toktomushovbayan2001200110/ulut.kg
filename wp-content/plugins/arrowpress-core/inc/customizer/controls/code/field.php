...
class Code extends Field {
	...
	public $type = 'arrowpress-code';

	protected $control_class = '\ArrowTheme\Customizer\Control\Code';
	...
	public function filter_control_args( $args, $wp_customize ) {
		if ( $args['id'] === $this->args['id'] ) {
			...
			$args['input_attrs'] = array(
				'aria-describedby' => 'arrowpress-code editor-keyboard-trap-help-1 editor-keyboard-trap-help-2 editor-keyboard-trap-help-3 editor-keyboard-trap-help-4',
			);
