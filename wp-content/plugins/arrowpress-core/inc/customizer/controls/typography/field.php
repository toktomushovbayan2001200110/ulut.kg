				...
				wp_parse_args(
					array(
						...
						'wrapper_attrs' => wp_parse_args(
							array(
								'arrowpress-typography-subcontrol-type' => 'font-family',
							),
							$args['wrapper_attrs']
						),
						'choices'     => array(),
			...
			new \ArrowTheme\Customizer\Field\Select(
				wp_parse_args(
					array(
						...
						'wrapper_attrs' => wp_parse_args(
							array(
								'arrowpress-typography-subcontrol-type' => 'font-family-variant',
							),
							$args['wrapper_attrs']
						),
						'multiple'    => true,
					...
					array(
						...
						'wrapper_attrs' => wp_parse_args(
							array(
								...
								'class' => $args['wrapper_attrs']['class'] . ' arrowpress-group-item arrowpress-w50',
							),
							$args['wrapper_attrs']
						),
						'choices'       => array(),
