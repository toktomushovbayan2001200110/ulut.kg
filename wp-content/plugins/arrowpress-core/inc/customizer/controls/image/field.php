...
class Image extends Field {
	...
	public $type = 'arrowpress-image';

	protected $control_class = '\ArrowTheme\Customizer\Control\Image';

	protected $control_has_js_template = true;

	protected function init( $args ) {
		add_filter( 'arrowpress_customizer_output_item_args', array( $this, 'output_item_args' ), 10, 4 );
	...
	public function output_control_classnames( $classnames ) {
		$classnames['arrowpress-image'] = '\ArrowTheme\Customizer\CSS\Image';
