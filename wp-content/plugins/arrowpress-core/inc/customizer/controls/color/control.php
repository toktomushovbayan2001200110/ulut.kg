...
class Color extends Base {
	...
	public function color_swatches() {
		...
		$default_swatches = apply_filters( 'arrowpress_customizer_default_color_swatches', $default_swatches );
		...
		$swatches = apply_filters( 'arrowpress_customizer_color_swatches', $swatches );
