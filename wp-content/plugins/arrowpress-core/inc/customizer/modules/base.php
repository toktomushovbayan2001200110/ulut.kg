<?php
namespace ArrowTheme\Customizer\Modules;
...
class Base extends \WP_Customize_Control {
	...
	public $arrowpress_config = 'global';
	...
	public function enqueue() {
		$script_info = include ARROWPRESS_CUSTOMIZER_DIR . '/build/customizer.asset.php';

		wp_enqueue_script( 'arrowpress-customizer-control', ARROWPRESS_CUSTOMIZER_URI . '/build/customizer.js', array_merge( $script_info['dependencies'], array( 'jquery-ui-sortable', 'jquery', 'customize-base', 'customize-controls' ) ), $script_info['version'], true );
		wp_enqueue_style( 'arrowpress-customizer-control', ARROWPRESS_CUSTOMIZER_URI . '/build/customizer.css', array( 'wp-components' ), $script_info['version'] );
	}

	protected function render() {
		$id    = 'customize-control-' . str_replace( array( '[', ']' ), array( '-', '' ), $this->id );
		$class = 'customize-control customize-control-arrowpress-customizer customize-control-' . $this->type;
		...
		if ( ! isset( $this->wrapper_attrs['data-arrowpress-customizer-setting'] ) ) {
			$this->wrapper_attrs['data-arrowpress-customizer-setting'] = $this->id;
		}

		if ( ! isset( $this->wrapper_attrs['data-arrowpress-customizer-setting-link'] ) ) {
			if ( isset( $this->settings['default'] ) ) {
				$this->wrapper_attrs['data-arrowpress-customizer-setting-link'] = $this->settings['default']->id;
			}
		}
	...
	public function to_json() {
		...
		// The kirki-config.
		$this->json['thimCustomizerConfig'] = $this->arrowpress_config;
