<?php
namespace ArrowTheme\Customizer\Modules\CSS;
...
final class Generator {
	...
	private function __construct() {
		$googlefonts = new \ArrowTheme\Customizer\Utils\GoogleFonts();
	...
	public static function css( $field ) {
		...
		$field['arrowpress_config'] = isset( $field['arrowpress_config'] ) ? $field['arrowpress_config'] : 'global';
		...
		self::$value = apply_filters( 'arrowpress_get_value', get_theme_mod( $field['id'], $default ), $setting_name, $default, $option_type );

		$classname            = '\ArrowTheme\Customizer\Modules\CSS\Output';
		$field_output_classes = apply_filters( 'arrowpress_customizer_output_control_classnames', [] );
		$field_output_classes = apply_filters( "arrowpress_customizer_{$field['arrowpress_config']}_output_control_classnames", $field_output_classes );

		if ( array_key_exists( self::$field_type, $field_output_classes ) ) {
			$classname = $field_output_classes[ self::$field_type ];
		}

		$obj = new $classname( $field['arrowpress_config'], self::$output, self::$value, $field );

		return $obj->get_styles();
	}

	public static function styles_parse( $css = [] ) {
		$css = apply_filters( 'arrowpress_customizer_styles_array', $css );
