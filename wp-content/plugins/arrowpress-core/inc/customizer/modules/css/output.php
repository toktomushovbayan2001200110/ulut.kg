...
class Output {
			...
			foreach ( $output['pattern_replace'] as $search => $replace ) {
				...
				switch ( $option_type ) {
					...
					default:
						...
						if ( ! $replacement ) {
							$replacement = Values::get_value( $this->field['arrowpress_config'], $replace );
						}
				}
	...
	protected function process_output( $output, $value ) {
		$output = apply_filters( 'arrowpress_customizer_output_item_args', $output, $value, $this->output, $this->field );
	...
	protected function process_property_value( $property, $value ) {
		$properties = apply_filters(
			'arrowpress_customizer_output_property_classnames',
			[
				'font-family'         => '\ArrowTheme\Customizer\Modules\CSS\Property\Fontfamily',
				'background-image'    => '\ArrowTheme\Customizer\Modules\CSS\Property\Backgroundimage',
				'background-position' => '\ArrowTheme\Customizer\Modules\CSS\Property\Backgroundposition',
			]
		);
