...
class Loading {
	...
	public function add_loader_to_footer() {
		?>
		<div class="arrowpress-customizer-loading-wrapper">
			<span class="arrowpress-customizer-loading"></span>
		</div>
		<?php
	}
	...
	public function add_loader_styles_to_header() {
		...
		<style>
			...
			.arrowpress-customizer-loading-wrapper {
				width: 100%;
				height: 100%;
				position: fixed;
				top: 0;
			...
			body.wp-customizer-unloading .arrowpress-customizer-loading-wrapper {
				display: block;
				opacity: 1;
			}
			.arrowpress-customizer-loading-wrapper .arrowpress-customizer-loading {
				position: absolute;
				width: 60px;
				height: 60px;
				top: 50%;
