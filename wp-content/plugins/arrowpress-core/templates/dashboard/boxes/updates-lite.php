...
do_action( 'arrowpress_core_background_check_update_theme_lite' );
                    ...
                    <p><?php if ( $is_active ) : ?>
                            ...
                            <?php else: ?>
                                <button class="button-link tc-update-now"
                                        type="button"><?php esc_html_e( 'Update now.', 'arrowpress-core' ); ?></button>
                            <?php endif; ?>
                        <?php else : ?>
                            <strong><?php printf( __( 'Please <a href="%1$s" class="tc-login-envato">login with Envato</a> to update theme.', 'arrowpress-core' ), '#arrowpress-core-product-registration' ); ?></strong>
                        <?php endif; ?>
                    </p>
                </div>
            <?php endif; ?>
