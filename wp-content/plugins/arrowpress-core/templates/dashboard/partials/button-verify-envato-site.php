...
$url_auth_callback = '';//Back to this site
...
$subscription_code = Arrowpress_Envato_Hosted::get_subscription_code();
?>

<form class="tc-form-verify-subscription-code"
      action="<?php echo esc_url( Arrowpress_Envato_Hosted::get_url_verify_subscription_code() ); ?>"
      method="post">
    <input type="hidden" name="theme" value="<?php echo esc_attr( $theme ); ?>">
    <input type="hidden" name="core_version" value="<?php echo esc_attr( ARROWPRESS_CORE_VERSION ); ?>">
    ...
    <button class="button button-primary tc-button activate-btn tc-run-step"
            type="submit"><?php esc_html_e( 'Verify', 'arrowpress-core' ); ?></button>
</form>
