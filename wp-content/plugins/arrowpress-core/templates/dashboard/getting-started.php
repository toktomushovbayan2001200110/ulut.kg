<?php
$steps       = Arrowpress_Getting_Started::get_steps();
...
<div class="arrowpress-getting-started">
    <header>
            ...
            foreach ( $steps as $index => $step ) :
                ...
                <li>
                    <a class="step" data-position="<?php echo esc_attr( $index ); ?>" data-step="<?php echo esc_attr( $step['key'] ); ?>"
                       title="<?php echo esc_attr( $step['title'] ); ?> <?php printf( __( '(%1$s of %2$s)', 'arrowpress-core' ), $position, $count_steps ); ?>"></a>
    ...
    <main>
		<?php
		do_action( 'arrowpress_getting_started_main_content' );
		?>
    </main>
</div>
