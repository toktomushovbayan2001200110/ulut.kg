...
$video_id        = arrowpress_parse_id_youtube( $video_customize );
?>
...
<div class="top">
    <div class="row">
		...
		<?php if ( $video_id ) : ?>
            <div class="col-md-6">
                <div class="arrowpress-video-youtube" data-video="<?php echo esc_attr( $video_id ); ?>" id="<?php echo esc_attr( $video_id ); ?>"></div>
            </div>
		<?php endif; ?>
    </div>
</div>
...
<div class="bottom">
    ...
    <a href="<?php echo esc_url( admin_url( 'customize.php?return=' . urlencode( Arrowpress_Getting_Started::get_link_redirect_step( 'support' ) ) ) ); ?>"
       class="button button-primary tc-button tc-run-step">
		<?php esc_html_e( 'Customize your site', 'arrowpress-core' ); ?>
    </a>
</div>
