...
$video_id       = arrowpress_parse_id_youtube( $video_intro );
$docs           = $links['docs'];
...
<div class="bottom">
    ...
    <button class="button button-primary tc-button tc-run-step"><?php esc_html_e( 'Next step →', 'arrowpress-core' ); ?></button>
</div>
