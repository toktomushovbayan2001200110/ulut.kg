...
<style id="arrowpress-core-admin-styles">
    .tc-base-color {
    ...
    /* Import demo */
    .tc-importer-wrapper .arrowpress-demo .status {
        background-color: <?php echo esc_attr( $base_color ); ?> !important;
    }

    .tc-importer-wrapper .arrowpress-demo .status:hover {
        background-color: <?php echo esc_attr( $background_color ); ?> !important;
    }

    /* Mega menu */
    .arrowpress-wrapper-mega-menu .field-arrowpress-sub-align input:checked {
        color: <?php echo esc_attr( $base_color ); ?> !important;
    }
